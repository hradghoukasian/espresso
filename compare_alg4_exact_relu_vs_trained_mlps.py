...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--test-size", type=int, default=2**12, help="ignored when --full-cube-test is used")
    ...
    p.add_argument("--epochs", type=int, default=2000, help="training epochs for trainable MLP baselines")
